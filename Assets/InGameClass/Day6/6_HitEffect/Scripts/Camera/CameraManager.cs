...
namespace HitEffect
{
    ...
    public class CameraManager : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            //画面を揺らすためにshakeAnglesを加算
            _camera.transform.localEulerAngles = _parameter.offsetAngles + shakeAngles;
        }
        ...
        public void Shake(float duration, Vector3 strength, int vibrato)
        {
            DOTween
                .Shake(
                () => shakeAngles,              //開始時の値
                shake => shakeAngles = shake,   //パラメータの更新
                duration,                       //持続時間
                strength,                       //揺れの強さ
                vibrato)                        //どのくらい振動するか
                .OnComplete(() => shakeAngles = Vector3.zero);
        }
